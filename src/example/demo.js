import MP3Info from '../audiocontext/mp3info/mp3info';
import Player from '../audiocontext/player';
import Util from '../audiocontext/common/util';

var totalTime = 0;
var myRange = document.getElementById("myRange");
window.mp3 = new Player('http://localhost:8000/res/test.mp3', {
    emptyUrl: 'http://localhost:8000/res/empty.mp3',
    AudioInfo: MP3Info,
