...
define(function(require, exports, module) {
    ...
    _proto_.parseId3V2 = function(){
		...
		function _getItem(){
			...
			switch(key){
				case 'TIT2': self.title = cont; break;
				case 'TPE1': self.artist = cont; break;
				case 'TALB': self.album = cont; break;
				case 'TYER': self.year = cont; break;
				case 'COMM': self.comment = cont; break;
				case 'TCON': self.genre = cont; break;
			}
		}
		return this.tagSize;
    }
    ...
    _proto_.parseApe = function(){
    	...
    	function _getItem(){
    		...
    		switch(key){
    			case 'Title': self.title = cont; break;
				case 'Artist': self.artist = cont; break;
				case 'Album': self.album = cont; break;
				case 'Year': self.year = cont; break;
				case 'Comment': self.comment = cont; break;
				case 'Genre': self.genre = cont; break;
    		}
    	}
    	return this.tagSize;
    }
